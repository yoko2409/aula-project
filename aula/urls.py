...
urlpatterns = [
                  ...
                  path('course/<int:pk>/', views.CourseItemView.as_view(), name='course_item'),
                  ...
                  path('assignments/<int:course_id>/create/', views.AssignmentCreateView.as_view(),
                  ...
                  path('submissions/<int:submission_id>/request_resubmission/', views.RequestResubmissionView.as_view(),
                       name='request_resubmission'),
                  path('questions/<int:course_id>/', views.QuestionListView.as_view(), name='question_list'),
                  path('question/<int:pk>/', views.QuestionMaterialDetail.as_view(), name='question_material_detail'),
                  path('questions/<int:course_id>/create', views.QuestionMaterialCreateView.as_view(),
                       name='question_material_create'),
                  path('choice/<int:pk>/create/', views.ChoiceCreateView.as_view(), name='choice_create'),
                  path('question/<int:pk>/answer/', views.AnswerQuestionView.as_view(), name='question_answer'),
                  path('question/<int:pk>/create', views.question_choice_create_view, name='question_create'),
